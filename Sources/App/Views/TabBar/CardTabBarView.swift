...
class CardTabBarView: UITabBar {
    fileprivate enum CardTabBarViewUI {
        static let padding: CGFloat = 20.scaleX
    }
    ...
    private lazy var backgroundShadowView: UIView = .build { shadowView in
        shadowView.layer.shadowOffset = CGSize(width: 10.scaleX, height: 10.scaleX)
        shadowView.layer.shadowRadius = 2.scaleX
...
//        shadowView.layer.shadowOpacity = 1
    ...
    override func layoutSubviews() {
        ...
        container.layer.cornerRadius = 33.scaleX
        addShadow()
    }
    ...
    private func setupConstraint() {
        ...
        NSLayoutConstraint.activate([
            container.leadingAnchor.constraint(equalTo: leadingAnchor, constant: CardTabBarViewUI.padding + 13.scaleX),
            container.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -CardTabBarViewUI.padding - 13.scaleX),
            container.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor, constant: -CardTabBarViewUI.padding - (Developer.isHasNortch ? -20.scaleX : 0.scaleX)),
            container.heightAnchor.constraint(equalToConstant: 66.scaleX),

            stackView.bottomAnchor.constraint(equalTo: container.bottomAnchor),
            stackView.topAnchor.constraint(equalTo: container.topAnchor),
            stackView.leadingAnchor.constraint(equalTo: container.leadingAnchor, constant: 10.scaleX),
            stackView.trailingAnchor.constraint(equalTo: container.trailingAnchor, constant: -10.scaleX),
            
            backgroundShadowView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: CardTabBarViewUI.padding),
            backgroundShadowView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: CardTabBarViewUI.padding),
            backgroundShadowView.bottomAnchor.constraint(equalTo: bottomAnchor),
            backgroundShadowView.topAnchor.constraint(equalTo: topAnchor, constant: -40.scaleX)
        ])
    }
